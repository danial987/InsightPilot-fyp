(function (a) {
  ...
  a(".service_slider_one").length &&
    a(".service_slider_one").slick({
      dots: !1,
      arrows: !1,
      centerPadding: "0px",
      slidesToShow: 3,
  ...
  a(".service_slider_two").length &&
    a(".service_slider_two").slick({
      dots: !1,
      arrows: !1,
      centerPadding: "0px",
      slidesToShow: 3,
  ...
  a(".portfolio_slider_one").length &&
    a(".portfolio_slider_one").slick({
      dots: !1,
      arrows: !0,
      prevArrow: a(".prev_p1"),
      nextArrow: a(".next_p1"),
  ...
  a(".circle_percent").length &&
    a(".circle_percent").each(function () {
      var b = a(this),
        c = b.data("percent"),
        d = 3.6 * c,
        e = b.find(".round_per");
  ...
  a(window).on("load", function () {
    ...
    a("[data-aos]").length &&
      AOS.init({ duration: 800, mirror: !0, once: !0, offset: 50 });
    var b = a(".fancybox");
    b.length &&
      b.fancybox({
        arrows: !0,
