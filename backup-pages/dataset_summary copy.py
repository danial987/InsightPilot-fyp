    ...
    def display_summary(df, dataset_name):
        ...
        with st.container(border=True):
            ...
            with overview_tab1:
                ...
                missing_delta_color = "off" if missing_cells == 0 else "inverse" if (missing_cells / (num_variables * num_observations)) * 100 > 10 else "normal"
                with row2_col1:
                ...
                duplicate_delta_color = "off" if duplicate_rows == 0 else "inverse" if (duplicate_rows / num_observations) * 100 > 5 else "normal"
                with row2_col2:
